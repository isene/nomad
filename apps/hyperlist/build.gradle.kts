...
// Identical wiring to apps/tasks (both consume the shared fe2o3-mobile-core
// crate). When app #3 lands, extract this into a shared build-logic plugin
// (rule of 3); for two apps the duplication is tolerable.
