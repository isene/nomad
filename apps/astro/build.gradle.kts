...
// Third app to use fe2o3-mobile-core (tasks, hyperlist, astro). TODO: extract
// this cargo-ndk + uniffi wiring into a shared build-logic convention plugin —
// it's now copied three times (rule of 3 reached).
