...
// Fourth app to use fe2o3-mobile-core (tasks, hyperlist, astro, mail).
// TODO: the cargo-ndk + uniffi wiring is now copied four times — extract it
// into a shared build-logic convention plugin.
...
android {
    ...
    packaging {
        resources {
            ...
            // Jakarta Mail finds its IMAP provider by reading these, and
            // both android-mail and android-activation ship a copy.
            merges += "META-INF/javamail.*"
